...
public class BaseActivity_1_WebViewClientClass
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("swirepaysdk.Droid.BaseActivity`1+WebViewClientClass, swirepaysdk.Android", BaseActivity_1_WebViewClientClass.class, __md_methods);
	}


	public BaseActivity_1_WebViewClientClass ()
	{
		super ();
		if (getClass () == BaseActivity_1_WebViewClientClass.class)
			mono.android.TypeManager.Activate ("swirepaysdk.Droid.BaseActivity`1+WebViewClientClass, swirepaysdk.Android", "", this, new java.lang.Object[] {  });
	}
